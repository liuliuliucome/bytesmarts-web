...
declare namespace Component {
  ...
  type HTMLProps<Tag extends AS.ReactTag = "div"> = AS.OmitReactTagProps<Tag>;

  type WithHTMLProps<T, Tag extends AS.ReactTag = "div"> = AS.OmitReactTagProps<
    Tag,
    T
  > &
    T;
   ...
   * 通用的 ui组件类包含属性
   */
  type UI<Props = {}> = UIBaseProps & Props;
  ...
  type WithChildren<Props = {}, C = React.ReactNode> = Omit<
    Props,
    "children"
  > & {
    children?: C;
