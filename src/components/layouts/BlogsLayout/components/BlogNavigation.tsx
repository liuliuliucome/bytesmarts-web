...
// type GroupItemProps<T extends ContentlayerBuilder.ValueType> = {
//   value: ContentlayerBuilder.GroupType<T>;
// };

// function GroupItem<T extends ContentlayerBuilder.ValueType>(
//   props: GroupItemProps<T>,
// ) {
//   const {} = props;
//   return (
//     <div
    ...
    <div>
      ...
      <div className="my-5">
        {mapChildren(options, ({ item, key }) => (
          ...
          >
            <Link
              href={LocalesUtil.toHref(["blog", item.slug], item.locale)}
